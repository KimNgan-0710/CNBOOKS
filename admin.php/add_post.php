...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($image) || empty($userName)) {
        ...
        try {
            // Thêm bài đăng mới
            $stmt = $pdo->prepare("INSERT INTO posts (image, user_name) VALUES (:image, :user_name)");
...
$extra_js = '
    ...
    // Hiển thị xem trước khi trang tải
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="user-input-container">
                <input type="text" id="user_name" name="user_name" value="<?= isset($userName) ? htmlspecialchars($userName) : '' ?>" required>
                <div id="userSuggestions" class="user-suggestions"></div>
            </div>
        </div>
        
        <div class="form-actions">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Lưu Bài Đăng</button>
