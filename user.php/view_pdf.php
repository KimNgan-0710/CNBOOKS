...
$stmt->execute([$product_id, "Tài liệu PDF"]);
...
$pdf_path = 'admin_area/product_pdfs/' . $book['product_id'] . '.pdf';
    ...
    <div class="container">
        <div class="book-header">
            ...
            <div class="book-info">
                ...
                <div class="book-meta">
                    <span>Tác giả: <?php echo htmlspecialchars($book['author']); ?></span>
                    <span>Loại: <?php echo htmlspecialchars($book['type_name']); ?></span>
                    <span>Mã: <?php echo $book['product_id']; ?></span>
                </div>
            </div>
        ...
        <?php if ($pdf_exists): ?>
            <div class="pdf-container">
                <iframe src="pdf_viewer.php?file=<?php echo urlencode($pdf_path); ?>" class="pdf-viewer" allowfullscreen></iframe>
            </div>
        <?php else: ?>
            <div class="no-pdf">
                <h2>Rất tiếc, file PDF của sách này không tồn tại.</h2>
